...
class IncidentDetector:
        ...
        try:
            with open(self.history_file, 'r') as f:
                ...
                self.incident_history = [
                    Incident(**incident) for incident in data
                ]
    ...
    def _save_history(self):
        ...
        try:
            with open(self.history_file, 'w') as f:
                json.dump(
                    [asdict(incident) for incident in self.incident_history],
                    f,
                    indent=2
                )
        except Exception as e:
    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        recent_incidents = [
            ...
            if datetime.fromisoformat(i.detected_at) > last_24h
        ]
        
        weekly_incidents = [
            i for i in self.incident_history
            if datetime.fromisoformat(i.detected_at) > last_7d
        ]
...
async def main():
    ...
    parser.add_argument(
        "--webhook-url",
        default=os.getenv("INCIDENT_WEBHOOK_URL"),
        help="Alert webhook URL (Slack, PagerDuty)"
    )
    parser.add_argument(
        "--interval",
        type=int,
    ...
    parser.add_argument(
        "--report",
        action="store_true",
        help="Generate and print incident report"
    )
    ...
    detector = IncidentDetector(
        ...
        alert_webhook=args.webhook_url,
