...
class NLPBenchmark:
    ...
    def __init__(self, model_path: str = None):
        ...
        self.results = {"intent_predictions": [], "entity_predictions": [], "latencies": [], "errors": []}
    ...
    def get_test_cases(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            # ==================== MAKE RESERVATION ====================
            {"text": "Quiero hacer una reserva", "expected_intent": "make_reservation", "expected_entities": []},
            {
                "text": "Reservame una habitación doble para el 20",
                "expected_intent": "make_reservation",
                "expected_entities": ["room_type", "date"],
            },
            {"text": "Dale, confirmo la reserva", "expected_intent": "make_reservation", "expected_entities": []},
            # ==================== CANCEL RESERVATION ====================
            {"text": "Necesito cancelar mi reserva", "expected_intent": "cancel_reservation", "expected_entities": []},
            {"text": "Quiero anular el booking", "expected_intent": "cancel_reservation", "expected_entities": []},
            {"text": "Tengo que cancelar por favor", "expected_intent": "cancel_reservation", "expected_entities": []},
            # ==================== MODIFY RESERVATION ====================
            {"text": "Quiero cambiar las fechas", "expected_intent": "modify_reservation", "expected_entities": []},
            {"text": "Puedo modificar mi reserva?", "expected_intent": "modify_reservation", "expected_entities": []},
            {
            ...
            # ==================== ASK PRICE ====================
            {"text": "Cuánto cuesta la habitación?", "expected_intent": "ask_price", "expected_entities": []},
            {
                "text": "Precio de la doble por favor",
                "expected_intent": "ask_price",
                "expected_entities": ["room_type"],
            },
            {"text": "Tarifa por noche?", "expected_intent": "ask_price", "expected_entities": []},
            # ==================== ASK AMENITIES ====================
            {"text": "Tiene piscina el hotel?", "expected_intent": "ask_amenities", "expected_entities": ["amenity"]},
            {"text": "Qué servicios incluye?", "expected_intent": "ask_amenities", "expected_entities": []},
            {"text": "Hay gimnasio y wifi?", "expected_intent": "ask_amenities", "expected_entities": ["amenity"]},
            # ==================== ASK LOCATION ====================
            {"text": "Dónde están ubicados?", "expected_intent": "ask_location", "expected_entities": []},
            {"text": "Cómo llego desde el aeropuerto?", "expected_intent": "ask_location", "expected_entities": []},
            # ==================== ASK POLICIES ====================
            {"text": "Cuál es el horario de check in?", "expected_intent": "ask_policies", "expected_entities": []},
            {"text": "Política de cancelación?", "expected_intent": "ask_policies", "expected_entities": []},
            {"text": "Se aceptan mascotas?", "expected_intent": "ask_policies", "expected_entities": []},
            # ==================== GREETING ====================
            {"text": "Hola", "expected_intent": "greeting", "expected_entities": []},
            {"text": "Buenos días", "expected_intent": "greeting", "expected_entities": []},
            # ==================== GOODBYE ====================
            {"text": "Chau gracias", "expected_intent": "goodbye", "expected_entities": []},
            {"text": "Hasta luego", "expected_intent": "goodbye", "expected_entities": []},
            # ==================== AFFIRM ====================
            {"text": "Sí", "expected_intent": "affirm", "expected_entities": []},
            {"text": "Dale ok", "expected_intent": "affirm", "expected_entities": []},
            # ==================== DENY ====================
            {"text": "No gracias", "expected_intent": "deny", "expected_entities": []},
            {"text": "Nop", "expected_intent": "deny", "expected_entities": []},
            # ==================== HELP ====================
            {"text": "Ayuda por favor", "expected_intent": "help", "expected_entities": []},
            {"text": "Qué puedo hacer?", "expected_intent": "help", "expected_entities": []},
            # ==================== OUT OF SCOPE ====================
            {"text": "Qué hora es?", "expected_intent": "out_of_scope", "expected_entities": []},
            {"text": "asdfghjkl", "expected_intent": "out_of_scope", "expected_entities": []},
        ]
    ...
    async def run_benchmark(self) -> Dict[str, Any]:
        ...
        for i, test_case in enumerate(test_cases, 1):
            ...
            try:
                ...
                self.results["entity_predictions"].append(
                    {
                        ...
                        "correct": set([e["entity"] for e in result.get("entities", [])])
                        == set(test_case["expected_entities"]),
                    }
                )
                ...
                self.results["errors"].append({"text": test_case["text"], "error": str(e)})
    ...
    def calculate_metrics(self) -> Dict[str, Any]:
        ...
        weighted_precision = (
            sum(m["precision"] * m["support"] for m in per_intent_metrics.values()) / total_support
            if total_support > 0
            else 0.0
        )
        weighted_recall = (
            sum(m["recall"] * m["support"] for m in per_intent_metrics.values()) / total_support
            if total_support > 0
            else 0.0
        )
        weighted_f1 = (
            sum(m["f1_score"] * m["support"] for m in per_intent_metrics.values()) / total_support
            if total_support > 0
            else 0.0
        )
        ...
        high_conf_accuracy = (
            sum(1 for p in high_confidence if p["correct"]) / len(high_confidence) if high_confidence else 0.0
        )
        ...
        return {
            ...
            "latency": {"avg_ms": avg_latency, "p50_ms": p50_latency, "p95_ms": p95_latency, "p99_ms": p99_latency},
    ...
    def generate_report(self, metrics: Dict[str, Any]) -> str:
        ...
        sorted_intents = sorted(metrics["per_intent"].items(), key=lambda x: x[1]["f1_score"], reverse=True)
