...
class QloAppsSetup:
        ...
        try:
            ...
            if room_types:
                ...
                for rt in room_types:
                    logger.info(f"  - ID: {rt.get('id')} | Name: {rt.get('name')} | Max Guests: {rt.get('max_guests')}")
            else:
    ...
    async def run_all_tests(self):
        ...
        results = {"connection": False, "hotels": [], "room_types": [], "availability": []}
        ...
        try:
            ...
            all_ok = results["connection"] and len(results["hotels"]) > 0 and len(results["room_types"]) > 0
