...
class CustomDashboardService:
        ...
        self.dashboards[DashboardRole.EXECUTIVE] = Dashboard(
            ...
            widgets=[
                DashboardWidget(
                    ...
                    config={"format": "currency", "currency": "EUR", "trend": True, "target": 18000},
                ...
                DashboardWidget(
                    ...
                    config={"format": "percentage", "trend": True, "target": 80},
                ...
                DashboardWidget(
                    ...
                    data_source="adr",
                    config={"format": "currency", "currency": "EUR", "trend": True},
                ...
                DashboardWidget(
                    ...
                    config={"format": "number", "trend": True, "target": 70},
                ...
                DashboardWidget(
                    ...
                    config={"x_axis": "date", "y_axis": "revenue", "lines": ["actual", "forecast", "target"]},
                ...
                DashboardWidget(
                    ...
                    config={"x_axis": "date", "y_axis": "occupancy", "lines": ["actual", "forecast"]},
                ...
                DashboardWidget(
                    ...
                    config={"value_field": "revenue", "label_field": "segment"},
                ...
                DashboardWidget(
                    ...
                    config={"x_axis": "channel", "y_axis": "bookings", "color_by": "revenue"},
            ...
            layout={"columns": 12, "row_height": 60, "margin": [10, 10], "container_padding": [10, 10]},
        )
        ...
        self.dashboards[DashboardRole.HOTEL_MANAGER] = Dashboard(
            ...
            widgets=[
                ...
                DashboardWidget(
                    ...
                    config={"min": 0, "max": 10, "thresholds": [6, 8, 9]},
                ...
                DashboardWidget(
                    ...
                    config={"columns": ["name", "department", "shift", "status"], "sortable": True},
        ...
        self.dashboards[DashboardRole.FRONT_DESK] = Dashboard(
            ...
            widgets=[
                ...
                DashboardWidget(
                    ...
                    config={"x_axis": "hour", "y_axis": "count", "time_format": "HH:00"},
        ...
        self.dashboards[DashboardRole.REVENUE_MANAGER] = Dashboard(
            ...
            widgets=[
                DashboardWidget(
                    ...
                    config={"x_axis": "date", "y_axis": "adr", "lines": ["our_adr", "comp_set_adr", "market_adr"]},
                ...
                DashboardWidget(
                    ...
                    config={"x_axis": "days_out", "y_axis": "bookings", "lines": ["current_year", "last_year"]},
                ...
                DashboardWidget(
                    ...
                    config={"value_field": "revenue", "label_field": "channel"},
    ...
    async def _get_daily_revenue_data(self) -> Dict[str, Any]:
        ...
        return {"value": 15750.00, "trend": 8.5, "target": 18000.00, "previous_period": 14500.00}

    async def _get_occupancy_data(self) -> Dict[str, Any]:
        """Get occupancy data"""
        return {"value": 78.5, "trend": 5.2, "target": 80.0, "previous_period": 74.6}

    async def _get_adr_data(self) -> Dict[str, Any]:
        """Get ADR data"""
        return {"value": 185.50, "trend": 3.8, "target": 190.00, "previous_period": 178.75}

    async def _get_nps_data(self) -> Dict[str, Any]:
        """Get NPS data"""
        return {"value": 67.0, "trend": -2.1, "target": 70.0, "previous_period": 68.5}
    ...
    async def _get_revenue_trend_data(self, days: int) -> Dict[str, Any]:
        ...
        return {"dates": dates, "series": {"actual": actual, "forecast": forecast[: len(dates)], "target": target}}
    ...
    async def _get_guest_satisfaction_data(self) -> Dict[str, Any]:
        ...
        return {"value": 8.7, "max": 10, "min": 0, "threshold_good": 8.0, "threshold_excellent": 9.0}
    ...
    async def _get_room_status_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "summary": {"occupied": 65, "vacant_clean": 25, "vacant_dirty": 8, "out_of_order": 2},
        }
