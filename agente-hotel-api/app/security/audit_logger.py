...
security_audit_duration = Histogram(
    ...
    "Security audit operation duration",
    ["operation"]
)
...
class SecurityAuditLogger:
    ...
    async def log_authentication_event(self, event_type: SecurityEventType, 
                                     user_id: Optional[str] = None,
                                     username: Optional[str] = None,
                                     ip_address: Optional[str] = None,
                                     user_agent: Optional[str] = None,
    ...
    async def log_access_event(self, user_id: str, endpoint: str, method: str,
                             result: str = "success",
                             ip_address: Optional[str] = None,
                             user_agent: Optional[str] = None,
                             session_id: Optional[str] = None,
    ...
    async def log_data_access_event(self, user_id: str, resource: str, action: str,
                                  result: str = "success",
                                  details: Optional[Dict[str, Any]] = None) -> bool:
    ...
    async def _check_suspicious_activity(self, event: SecurityEvent):
        ...
        try:
            ...
            if event.user_agent and self._is_suspicious_user_agent(event.user_agent):
                await self._log_suspicious_activity(
                    SuspiciousActivityType.UNUSUAL_USER_AGENT,
                    event.ip_address,
    ...
    async def _log_suspicious_activity(self, activity_type: SuspiciousActivityType,
