...
failed_login_attempts_gauge = Gauge(
...
class AdvancedJWTAuth:
    ...
    def create_jwt_token(self, user_id: str, token_type: TokenType, 
                        expires_delta: Optional[timedelta] = None,
                        extra_claims: Optional[Dict[str, Any]] = None) -> JWTToken:
        """Create JWT token"""
    ...
    async def authenticate_user(self, username: str, password: str, 
        ...
        try:
            ...
            # Update metrics
            auth_duration_seconds.labels(operation="authenticate").observe(
    ...
    async def refresh_token(self, refresh_token: str) -> Optional[JWTToken]:
        ...
        try:
            ...
            if self.redis_client:
                await self.redis_client.setex(
                    f"access_token:{new_access_token.jti}",
                    int(self.access_token_expire.total_seconds()),
                    user_id
                )
    ...
    async def validate_token(self, token: str, required_permissions: Optional[List[Permission]] = None) -> Optional[Dict[str, Any]]:
