...
class QRService:
    ...
    def generate_checkin_qr(
        ...
        try:
            ...
            logger.error(
                "Failed to generate check-in QR code",
                booking_id=booking_id,
                error=str(e),
                exc_info=True
            )
    ...
    def generate_service_qr(
        ...
        try:
            ...
            logger.error(
                "Failed to generate service QR code",
                service_type=service_type,
                error=str(e),
                exc_info=True
            )
    ...
    def _add_branding(self, qr_img: Image.Image, qr_data: Dict) -> Image.Image:
        ...
        try:
            ...
            logger.warning(
                "Failed to add branding, returning plain QR",
                error=str(e)
            )
            return qr_img
