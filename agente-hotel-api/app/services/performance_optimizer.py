...
performance_metrics_gauge = Gauge(
    "system_performance_metrics", "Métricas de performance del sistema", ["metric_type", "component"]
)

optimization_actions_total = Counter(
    "performance_optimization_actions_total", "Total de acciones de optimización ejecutadas", ["action_type", "status"]
)
...
class PerformanceOptimizer:
    ...
    async def _collect_db_metrics(self) -> Dict:
        ...
        try:
            async with AsyncSessionFactory() as session:
                ...
                return {"connections": connections or 0, "slow_queries": slow_queries}
        except Exception as e:
    ...
    async def _collect_cache_metrics(self) -> Dict:
        ...
        try:
            ...
            return {"hit_rate": hit_rate, "memory_usage": memory_usage}
        except Exception as e:
    ...
    async def _preload_frequent_data(self):
        ...
        try:
            ...
            await self.redis_client.setex(
                "preload:hotel_config",
                7200,
                json.dumps({"name": "Hotel Example", "rooms": 100, "amenities": ["wifi", "pool", "spa"]}),
            )

            # Pre-cargar templates de respuesta
            await self.redis_client.setex(
                "preload:response_templates",
                7200,
                json.dumps(
                    {
    ...
    async def auto_optimize(self) -> Dict:
        ...
        try:
            ...
            if not actions:
                ...
                return {"status": "no_optimization_needed", "metrics": metrics.__dict__, "actions_taken": 0}
            ...
            return {"status": "error", "error": str(e), "actions_taken": 0}
