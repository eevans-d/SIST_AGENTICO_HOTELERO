...
nlp_language_detection = Counter("nlp_language_detection_total", "Language detection results", ["detected_language", "source"])
...
class NLPEngine:
    ...
    LANGUAGE_MARKERS = {
        "es": ["hola", "gracias", "por favor", "hotel", "habitación", "reserva", "disponibilidad", 
               "buenas", "quiero", "necesito", "días", "noches", "precio", "cuánto"],
        "en": ["hello", "thanks", "please", "hotel", "room", "booking", "reservation", "availability", 
               "good", "want", "need", "days", "nights", "price", "how much"],
        "pt": ["olá", "obrigado", "por favor", "hotel", "quarto", "reserva", "disponibilidade", 
               "bom", "quero", "preciso", "dias", "noites", "preço", "quanto"]
    }
    def __init__(
        self, 
    ...
    def _initialize_language_detector(self) -> Optional[Any]:
        ...
        try:
            ...
            return fasttext.load_model(os.getenv(
    ...
    async def process_message(
        ...
        try:
            ...
            result = await self.circuit_breaker.call(
                self._process_with_retry, text, language
            )
