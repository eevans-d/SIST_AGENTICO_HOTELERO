...
db_tuning_duration = Histogram(
    "db_tuning_duration_seconds", "Tiempo tomado por operaciones de tuning de DB", ["operation"]
)

db_performance_metrics = Gauge("db_performance_metrics", "Métricas de performance de base de datos", ["metric_type"])

db_optimization_actions = Counter(
    "db_optimization_actions_total", "Total de acciones de optimización de DB ejecutadas", ["action_type", "status"]
)
    ...
    async def start(self):
        ...
        try:
            self.db_engine = create_async_engine(
                settings.postgres_url, pool_size=5, max_overflow=10, pool_pre_ping=True, echo=False
            )
    ...
    async def get_performance_report(self) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "unused_indexes": {"count": len(unused_indexes), "indexes": unused_indexes[:5]},
