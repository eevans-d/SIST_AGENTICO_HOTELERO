...
class EnhancedNLPEngine:
    ...
    async def _load_model_for_language(self, language_code: str):
        ...
        try:
            ...
            agent = await loop.run_in_executor(None, lambda: Agent.load(str(model_path)))
        ...
        try:
            ...
            for entity in result.get("entities", []):
                nlp_entity_extractions.labels(
                    entity_type=entity.get("entity", "unknown"), extractor=entity.get("extractor", "unknown")
                ).inc()
    ...
    async def handle_low_confidence(
        self, intent: Dict[str, Any], language_code: str = None
