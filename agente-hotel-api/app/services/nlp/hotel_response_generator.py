...
from .enhanced_nlp_engine import IntentType, EntityType
...
class HotelResponseGenerator:
        ...
        return {
            ...
            "room_types": {
                ...
                "suite": {
                    ...
                    "capacity": 4,
                    "price": 350,
                    "amenities": ["Sala separada", "TV", "WiFi", "Aire acondicionado", "Minibar", "Jacuzzi", "Vista panorámica"]
                }
            },
            "services": {
    ...
    async def generate_response(self, context: ConversationContext, 
        ...
        main_response = await self._generate_main_response(
            context, processing_result, response_type, tone
        )
        ...
        formatted_response = self._format_response(
            main_response, follow_up, quick_replies, tone
        )
    ...
    def _determine_response_type(self, context: ConversationContext, 
                                processing_result: Dict[str, Any]) -> ResponseType:
    ...
    async def _generate_main_response(self, context: ConversationContext,
                                    processing_result: Dict[str, Any],
                                    response_type: ResponseType,
                                    tone: ResponseTone) -> str:
        ...
        filled_template = await self._fill_template_placeholders(
            template_text, context, processing_result
        )
        
        return filled_template
    
    async def _fill_template_placeholders(self, template: str, 
    ...
    async def _generate_follow_up(self, context: ConversationContext,
    ...
    def _generate_quick_replies(self, context: ConversationContext,
    ...
    def _format_response(self, main_text: str, follow_up: Optional[str],
                        quick_replies: List[str], tone: ResponseTone) -> Dict[str, Any]:
