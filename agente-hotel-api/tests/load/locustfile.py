...
def _(parser):
    ...
    parser.add_argument(
        ...
        help="Tenant ID para testing multi-tenant"
    )
...
def on_test_start(environment, **kwargs):
    ...
    print(f"   Tenant: {environment.parsed_options.tenant_id if hasattr(environment.parsed_options, 'tenant_id') else 'default'}")
