...
class TestRateLimitingMiddleware:
    ...
    def test_rate_limit_exceeded(self):
        ...
        def check_rate_limit(ip, limit=100, window_minutes=1):
            ...
            return {"allowed": True, "current_count": 50, "limit": limit}
...
class TestAuthorizationMiddleware:
    ...
    def test_role_based_access_control(self):
        ...
        def check_role_access(user_role, required_role):
            role_hierarchy = {"guest": 1, "receptionist": 2, "manager": 3, "admin": 4, "system": 5}
...
class TestDataEncryptionMiddleware:
    ...
    def test_request_data_encryption_detection(self):
        ...
        def needs_encryption(endpoint, method):
            encrypted_endpoints = ["/api/reservations", "/api/guests", "/api/payments", "/admin"]
    ...
    def test_sensitive_data_detection(self):
        ...
        sensitive_data = {
            "username": "testuser",
            "password": "secret123",
            "profile": {"email": "test@example.com", "phone": "+1234567890"},
        }
        assert contains_sensitive_data(sensitive_data) is True

        # Test data without sensitive information
        non_sensitive_data = {"room_type": "deluxe", "check_in": "2024-01-15", "check_out": "2024-01-20"}
...
class TestMiddlewarePerformance:
    ...
    def test_memory_usage_efficiency(self):
        ...
        middleware_state = {"rate_limits": {}, "blocked_ips": set(), "active_sessions": {}, "security_events": []}
    ...
    def test_error_handling_in_middleware(self):
        ...
        def middleware_with_error_handling(request):
            try:
                ...
                return {"success": False, "error": "Internal security error", "details": str(e)}
