...
def mock_audit_logger():
    ...
    class MockAuditLogger:
        ...
        async def get_logs(self, limit: int = 100, offset: int = 0, event_type: str = None, user_id: str = None):
...
class SecurityTestDataGenerator:
    ...
    def generate_malicious_payloads():
        ...
        return {
            "sql_injection": ["' OR '1'='1", "'; DROP TABLE users;--", "' UNION SELECT * FROM users--"],
            ...
            "command_injection": ["; ls -la", "| cat /etc/passwd", "&& rm -rf /"],
        }
