...
class DeploymentValidator:
    ...
    async def check_api_endpoints(self) -> Dict[str, bool]:
        ...
        try:
            response = await self.client.post("/api/v1/webhooks/whatsapp", json={})
...
async def test_concurrent_health_checks():
    ...
    async with DeploymentValidator() as validator:
        ...
        tasks = [validator.check_health_endpoints() for _ in range(10)]
...
if __name__ == "__main__":
    # Run smoke tests
    pytest.main([__file__, "-v", "-m", "deployment", "--tb=short"])
