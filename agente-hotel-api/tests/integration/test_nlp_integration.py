...
class TestNLPEngine:
    ...
    async def test_process_message_check_availability(self, nlp_engine_with_mock):
        ...
        nlp_engine_with_mock.agent.parse_message.return_value = {
            ...
            "entities": [{"entity": "date", "value": "2025-10-15", "start": 20, "end": 30}],
        }

        result = await nlp_engine_with_mock.process_message("¿Hay disponibilidad para el 15 de octubre?")
    ...
    async def test_process_message_make_reservation(self, nlp_engine_with_mock):
        ...
        result = await nlp_engine_with_mock.process_message("Quiero reservar para el 20 de octubre para 2 personas")
    ...
    async def test_process_message_cancel_reservation(self, nlp_engine_with_mock):
        ...
        result = await nlp_engine_with_mock.process_message("Necesito cancelar mi reserva")
    ...
    async def test_process_message_ask_price(self, nlp_engine_with_mock):
        ...
        nlp_engine_with_mock.agent.parse_message.return_value = {
            ...
            "entities": [{"entity": "room_type", "value": "doble", "start": 20, "end": 25}],
        }

        result = await nlp_engine_with_mock.process_message("Cuánto cuesta la habitación doble?")
    ...
    async def test_process_message_low_confidence(self, nlp_engine_with_mock):
        ...
        result = await nlp_engine_with_mock.process_message("algo para el finde?")
    ...
    async def test_process_message_very_low_confidence(self, nlp_engine_with_mock):
        ...
        result = await nlp_engine_with_mock.process_message("asdfghjkl blablabla")
...
class TestDateExtractor:
    ...
    def test_extract_date_range_del_al(self):
        ...
        entities = [{"entity": "date", "value": "2025-10-15"}, {"entity": "date", "value": "2025-10-20"}]
