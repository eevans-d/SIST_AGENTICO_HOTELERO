...
"""Gmail integration tests (partially skipped for Path A baseline).

Se mantendrán activos tests de normalización puros; se omiten temporalmente
escenarios de IMAP/SMTP reales y manejo de errores por diferencias de mapeo
...
"""
    ...
    def test_send_response_success(self, mock_smtp):
        ...
        result = client.send_response(
            to="guest@example.com", subject="Confirmación de reserva", body="Su reserva ha sido confirmada."
        )
