...
class TestQRService:
    ...
    def test_generate_checkin_qr_success(self, qr_service):
        ...
        result = qr_service.generate_checkin_qr(
            booking_id="HTL-12345",
            room_number="205",
    ...
    def test_generate_service_qr_different_types(self, qr_service):
        ...
        for service_type in service_types:
            result = qr_service.generate_service_qr(
                service_type,
                {"service_id": f"{service_type}_001"}
            )
    ...
    def test_cleanup_old_qr_codes_success(self, qr_service):
        ...
        qr_service.generate_booking_qr(
            "HTL-001", "Test Guest", "2025-10-15", "2025-10-17"
        )
    ...
    def test_file_naming_patterns(self, qr_service):
        ...
        # Booking QR
        booking_result = qr_service.generate_booking_qr(
            "HTL-001", "Test", "2025-10-15", "2025-10-17"
        )
