...
async def test_make_reservation_with_audio():
    ...
    session = {}
    nlp_result = {"intent": {"name": "make_reservation", "confidence": 0.95}, "language": "es"}
...
async def test_show_room_options_with_audio():
    ...
    # Crear una sesión y resultado NLP simulado
    session = {}
    nlp_result = {"intent": {"name": "show_room_options", "confidence": 0.95}, "language": "es"}
...
async def test_default_fallback_with_audio():
    ...
    # Crear una sesión y resultado NLP simulado
    session = {}
    nlp_result = {"intent": {"name": "unknown_intent", "confidence": 0.3}, "language": "es"}
